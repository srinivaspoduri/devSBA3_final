...
//	
//	@Test
//	public void testDataExistsExceptionByRegesteringExistingLeader() throws Exception {
//		LeaderDto politicalLeaderDto = MasterData.getLeaderDto();
//		when(this.leaderService.registerPoliticalLeader(politicalLeaderDto))
//		.thenThrow(new DataExistsException("Leader already registerd with party , please update the leader data"));
//
//		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/politics/api/v1/leader/register-leader")
//				.content(MasterData.asJsonString(politicalLeaderDto)).contentType(MediaType.APPLICATION_JSON)
//				.accept(MediaType.APPLICATION_JSON);
...
//		testAssert(currentTest(),
//				(result.getResponse().getContentAsString().contains("Leader already registerd with party , please update the leader data") ? "true" : "false"),
//				exceptionTestFile);
//
//	}
